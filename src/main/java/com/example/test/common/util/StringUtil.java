...
public class StringUtil {
    ...
    public static String nil(String s, String _default) {
        if (StringUtil.nil(s)) return _default;
        else return s;
    }
    ...
    public static int parseInt(String flag) {
        if (nil(flag)) return 0;
        else if (flag.equals("true")) return 1;
        else if (flag.equals("false")) return 0;
